  ...
  return (
    <motion.div className="relative w-full min-h-screen flex justify-center items-center gap-4 p-8 flex-col overflow-hidden">
      ...
      <span className="flex justify-center items-center gap-8 flex-col ">
        <h1 className="md:text-7xl text-3xl text-white font-bold bg-clip-text bg-gradient-to-r from-white via-green-600 to-white text-center">
          Start your <span className="text-color">Company</span> from scratch
        </h1>
        <p className="md:text-3xl text-xl text-white text-center font-semibold">
          Give your best shot !
        </p>
      </span>
    </motion.div>
