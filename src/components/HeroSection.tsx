...
const imagesRow1 = ["/img1.webp", "/img2.webp", "/img3.webp"];
const imagesRow3 = ["/img7.webp", "/img9.webp", "/img10.webp"];
  ...
  <div className="flex items-center gap-x-4 px-4">
    {Array.from({ length: 4 }).map((_, i) =>
      imageList.map((src, index) => (
        <div
          key={`${i}-${index}`}
          className="relative flex-shrink-0 w-[300px] md:w-[250px] sm:w-[200px] h-[200px] md:h-[170px] sm:h-[140px] rounded-md overflow-hidden"
        >
          <Image
            src={src}
            alt={`Image ${index}`}
